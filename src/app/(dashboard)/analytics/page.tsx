...
const LEADS_SELECT = 'id, list_record_id, ad_name, status, last_call_result, inquiry_at, list_created_at, jitsuyo_ok, ichiyou_ng, order_closed, deal_amount, adjusting, source_data, initial_fee, monthly_fee'
